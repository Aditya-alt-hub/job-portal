...
//         try {
//             const res = await axios.get(`${APPLICATION_API_END_POINT}/jobApply/${jobId}`, {withCredentials:true});
...
//             try {
//                 const res = await axios.get(`${JOB_API_END_POINT}/getJobsById/${jobId}`,{withCredentials:true});
//                 if(res.data.success){
...
const JobDescription = () => {
    ...
    useEffect(() => {
        const fetchSingleJob = async () => {
            try {
                const res = await axios.get(
                    `${JOB_API_END_POINT}/getJobsById/${jobId}`,
                    { withCredentials: true }
                );
